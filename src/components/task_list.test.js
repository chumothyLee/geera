...
describe('<TaskList />', () => {
      ...
      it('renders without crashing', () => {
        ...
        ReactDOM.render(<TaskList tasks={sampleTasks} handleReadTask={() => {console.log("handleReadTask")}} handleDeleteTask={() => {console.log("handleDeleteTask")}} handleSwitchTask={() => {console.log("handleSwitchTask")}} /> , div);
        ReactDOM.unmountComponentAtNode(div);
      });

      it('checks for ListGroup component', () => {
